          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            ?>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="panel_categoria_registar.php"><i class="fa fa-circle-o"></i> Registrar </a>
                  </li>
                  <li>
                    <a href="editar_Categoria.php"><i class="fa fa-circle-o"></i> Reportes </a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
            ...
            ?>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="panel_categoria_registrar.php"><i class="fa fa-circle-o"></i> Registrar </a>
                  </li>
                  <li>
                    <a href="editar_Categoria.php"><i class="fa fa-circle-o"></i> Reportes </a>
                  </li>
