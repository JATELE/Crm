  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      if ($privilegios_usuario == 1) {
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cube"></i> <span>Campañas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li>
              <a href="panel_campaña_registrar.php"><i class="fa fa-circle-o"></i> Registrar </a>
            </li>
            <li>
            ...
            <li>
              <a href="panel_promociones.php"><i class="fa fa-circle-o"></i> Promociones </a>
                ...
                <li class="treeview">
          <a href="#">
            <i class="fa fa-users"></i> <span>Encuestas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li>
              <a href="panel_encuesta_registrar.php"><i class="fa fa-circle-o"></i> Registrar</a>
            </li>
            <li>
              <a href="panel_crear_encuesta.php"><i class="fa fa-circle-o"></i> Crear Encuesta </a>
            </li>
            <li>
