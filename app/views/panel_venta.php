                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="#" readonly disabled="true"
                          placeholder="Ej. Juan Aguilar">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Correo Electronico</label>
                        <input type="email" class="form-control" id="#" readonly disabled="true"
              ...
              <div class="box-body">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <p>
                        <input type="text" class="form-control" disabled readonly id="####"
                          value="<?php echo $nombre_usuario . ' ' . $apellido_usuario; ?>">
                      </p>
                    </div>
                    <!-- /.input group -->
                  </div>
                ...
                <div class="col-lg-12">
                  <table class="table table-hover table-responsive table-sm" id="tablaProductos">
                    ...
                    <tfoot>
                      <tr>
                        <td><input type="text" class="form-control" id="codigo_producto" placeholder="000"
                            style="width:10vw; text-align: center;"></td>
                        <td>Lorem ipsum dolor sit amet consectetur</td>
                        <td>22</td>
                        <td><input type="text" class="form-control" id="cantidad" placeholder="000"
                            style="width:10vw; text-align: center;"></td>
                        <td>300</td>
                        <td>60000</td>
